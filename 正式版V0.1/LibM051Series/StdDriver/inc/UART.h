...
#define _UART_SEL_FUNC(UART,eFuncSel)   ((UART)->FUNSEL = ((UART)->FUNSEL & ~UART_FUN_SEL_FUN_SEL_Msk) | (eFuncSel))
...
__INLINE void UART_RS485Init ( UART_T *UART, uint32_t u32Mode, uint32_t u32Para )
{
    ...
    ( UART )->ALTCON  = ( u32Mode ) | ( ( ( u32Mode ) &UART_ALT_CSR_RS485_AAD_Msk ) ? ( ( ( u32Para ) << UART_ALT_CSR_ADDR_MATCH_Pos ) | UART_ALT_CSR_RS485_ADD_EN_Msk ) : 0 );
}
 ...
 *
 */
#define _UART_SET_LIN_TXMODE(UART,BreakLength) ((UART)->ALTCON = (BreakLength) | UART_ALT_CSR_LIN_TX_EN_Msk)
...
#define _UART_SET_LIN_RXMODE(UART,BreakLength) ((UART)->ALTCON = (BreakLength) | UART_ALT_CSR_LIN_RX_EN_Msk)
